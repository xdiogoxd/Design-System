...
var require_react_dom_development = __commonJS({
  "../../node_modules/react-dom/cjs/react-dom.development.js"(exports2) {
    ...
    "production" !== process.env.NODE_ENV && function() {
      ...
      var React21 = require("react"), Internals = {
        d: {
          f: noop,
          r: function() {
            throw Error(
...
function Avatar2(props) {
  return /* @__PURE__ */ import_react7.default.createElement(AvatarContainer, null, /* @__PURE__ */ import_react7.default.createElement(AvatarImage2, { ...props }), /* @__PURE__ */ import_react7.default.createElement(AvatarFallback2, { delayMs: 600 }, /* @__PURE__ */ import_react7.default.createElement(User_esm_default, null)));
}
...
var TextInput = (0, import_react9.forwardRef)(
  ({ prefix, size, ...props }, ref) => {
    return /* @__PURE__ */ import_react9.default.createElement(TextInputContainer, null, !!prefix && /* @__PURE__ */ import_react9.default.createElement(Prefix, null, prefix), /* @__PURE__ */ import_react9.default.createElement(Input, { ref, ...props }));
  }
);
...
var Checkbox = React18.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(CheckboxProvider, { scope: __scopeCheckbox, state: checked, disabled, children: [
...
var CheckboxIndicator = React18.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Presence, { present: forceMount || isIndeterminate(context.state) || context.state === true, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      Primitive2.span,
      {
...
function Checkbox2(props) {
  return /* @__PURE__ */ import_react10.default.createElement(CheckboxContainer, { ...props }, /* @__PURE__ */ import_react10.default.createElement(CheckboxIndicator2, { asChild: true }, /* @__PURE__ */ import_react10.default.createElement(Check_esm_default, { weight: "bold" })));
}
...
function MultiStep({ size, currentStep = 1, ...props }) {
  return /* @__PURE__ */ import_react11.default.createElement(MultiStepContainer, null, /* @__PURE__ */ import_react11.default.createElement(Label, null, "Passo ", currentStep, " de ", size), /* @__PURE__ */ import_react11.default.createElement(Steps, { css: { "--steps-size": size } }, Array.from({ length: size }, (_, i2) => i2 + 1).map((step) => {
