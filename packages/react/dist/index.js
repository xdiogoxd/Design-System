...
function TextInput({ prefix, ...props }) {
  return /* @__PURE__ */ import_react4.default.createElement(TextInputContainer, null, !!prefix && /* @__PURE__ */ import_react4.default.createElement(Prefix, null, prefix), /* @__PURE__ */ import_react4.default.createElement(Input, { ...props }));
}
...
function MultiStep({ size, currentStep = 1, ...props }) {
  return /* @__PURE__ */ import_react6.default.createElement(MultiStepContainer, null, /* @__PURE__ */ import_react6.default.createElement(Label, null, "Passo ", currentStep, " de ", size), /* @__PURE__ */ import_react6.default.createElement(Steps, { css: { "--steps-size": size } }, Array.from({ length: size }, (_, i) => i + 1).map((step) => {
    return /* @__PURE__ */ import_react6.default.createElement(Step, { key: step, active: currentStep >= step });
  })));
}
